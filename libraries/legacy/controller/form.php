...
class JControllerForm extends JControllerLegacy
{
	...
	public function save($key = null, $urlVar = null)
	{
		...
		if (!$model->save($validData))
		{
			...
			// Overwrite the error for custom component. 
			if (strpos($model->getError(),'Duplicate entry') !== false) 
				if (strpos($model->getError(),'subchannel_featured') !== false) 
					$model->setError('Rule for that category already exists!');
