...
JPluginHelper::importPlugin('content', 'addthis');
$dispatcher = JEventDispatcher::getInstance();

$custom_social_icons = new stdClass();

//getting row params for plugin
$custom_social_icons->title				= $this->recipe->title;
$custom_social_icons->recipe 			= true;
$custom_social_icons->article_url 		= JUri::getInstance()->toString();

$data = array(&$custom_social_icons, &$params, $page);

$dispatcher->trigger('onPrepareContent', $data);
?>
	...
	<div class="icons">
		<div class="btn-group pull-right">
			<ul class="article-icons">
				<li class="print-icon"> <?php echo JHtml::_('yoorecipeicon.print_popup', $recipe, $yooRecipeparams); ?> </li>

				<li class="email-icon"> <?php echo JHtml::_('yoorecipeicon.email', $recipe, $yooRecipeparams); ?> </li>
...
?>
<?php 
JPluginHelper::importPlugin('content', 'jw_disqus');
$dispatcher = JEventDispatcher::getInstance();

$jw_disqus_row = new stdClass();

//getting row params for plugin
$jw_disqus_row->id 				= $this->recipe->id;
$jw_disqus_row->catid 			= $this->recipe->categories[0]->id;
$jw_disqus_row->access 			= 1;
$jw_disqus_row->readmore_link 	= $_SERVER['REQUEST_URI'];
$jw_disqus_row->slug 			= $this->recipe->slug;
$jw_disqus_row->catslug 		= $this->recipe->catslug;

$data = array(&$jw_disqus_row, &$params, $page);
$dispatcher->trigger('renderDisqus', $data);
