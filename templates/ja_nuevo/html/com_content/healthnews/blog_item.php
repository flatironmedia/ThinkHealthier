...
<?php endif; ?>
	...
	<article>
		...
		<?php if($images): ?>
		<div class="intro-image-wrap pull-<?php echo htmlspecialchars($imgfloat); ?>">
		<?php endif ?>
		...
		<section class="article-intro clearfix" itemprop="articleBody">
			...
			<footer class="article-footer clearfix">
			  ...
			  <?php 
			  // echo('<pre>'.print_r($params->get('show_readmore'), true).'</pre>');
			  // die('<pre>'.print_r($this->item->readmore, true).'</pre>');
