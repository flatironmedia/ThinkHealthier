...
<div id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="genericItemList">
		...
		<div class="genericItemView catItemView">
		  ...
		  <?php if($this->params->get('genericItemTitle')): ?>
			  <!-- Item title -->
			  <h2 class="genericItemTitle catItemTitle">
		  ...
		  <div class="genericItemBody catItemBody">
		  ...
		  <?php endif; ?>
			...
			<!-- Item "read more..." link -->
			<div class="genericItemReadMore catItemReadMore">
