...
<div class="latestItemView catItemView">
	...
	<div class="latestItemHeader catItemHeader">
	 	<?php if($this->item->params->get('latestItemDateCreated')): ?>
		<!-- Date created -->
		<span class="latestItemDateCreated">
			<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC3')); ?>
		</span>
		<?php endif; ?>

		<?php if($this->item->params->get('latestItemCategory')): ?>
		<!-- Item category name -->
		<div class="latestItemCategory catItemCategory">
  ...
  <div class="latestItemLinks catItemLinks">
	<div class="row">
