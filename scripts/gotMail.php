...
include_once($_SERVER["DOCUMENT_ROOT"] . "/scripts/subscribe/whichSubDB.php");
...
//commented out Aleksandar@OGOSense
//else {
// 	$channel = 'diet';
// }
//end
...
if ($sub == 1) {
	header('Location: http://www.mydailymoment.com/scripts/gotMailSuccess.php?sub=' . $sub . '&channel=' . $channel);
}
?>
...
<?php //include_once($_SERVER["DOCUMENT_ROOT"] . "/scripts/subscribe/googleAnalytics.php"); ?>
...
if (!file_exists($_SERVER['DOCUMENT_ROOT'] . $hdrImage)) {
	$hdrImage = "/images/nls/gotMail/gotmailbesthdr.png";
}
