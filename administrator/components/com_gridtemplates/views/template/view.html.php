 ...
 * View to edit
 */
class GridtemplatesViewTemplate extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = GridtemplatesHelper::getActions();

        JToolBarHelper::title(JText::_('COM_GRIDTEMPLATES_TITLE_TEMPLATE'), 'template.png');
