...
class YooRecipeViewComment extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_YOORECIPE_MANAGER_REVIEW_NEW') : JText::_('COM_YOORECIPE_MANAGER_REVIEW_EDIT'), 'yoorecipe');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_YOORECIPE_MANAGER_REVIEW_NEW') : JText::_('COM_YOORECIPE_MANAGER_REVIEW_EDIT'));
	}
}