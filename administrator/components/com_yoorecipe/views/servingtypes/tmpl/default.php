...
<form action="<?php echo JRoute::_('index.php?option=com_yoorecipe&view=servingtypes'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="servingtypeList">
			<thead>
				<tr>
					...
					<th class="nowrap">
						<?php echo JText::_('COM_YOORECIPE_YOORECIPE_HEADING_LABEL'); ?>
					</th>
			...
			?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="hidden-phone">
						<a href="<?php echo JRoute::_('index.php?option=com_yoorecipe&task=servingtype.edit&id=' . $item->id); ?>"><?php echo $item->code; ?></a>
					</td>
					<td>
						<?php echo JText::_('COM_YOORECIPE_SERVING_TYPE_'.$item->code); ?><br/>
						<small>(<?php echo 'COM_YOORECIPE_SERVING_TYPE_'.$item->code; ?>)</small>
					</td>
					<td class="nowrap center hidden-phone">
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'servingtypes.'); ?>
					</td>
					<td class="nowrap center hidden-phone">
