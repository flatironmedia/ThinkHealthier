...
class YooRecipeViewImpex extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		// JToolBarHelper::custom('impex.import', 'publish.png', 'publish.png', 'COM_YOORECIPE_IMPORT', false);
		// JToolBarHelper::custom('impex.export', 'publish.png', 'publish.png', 'COM_YOORECIPE_EXPORT', false);
