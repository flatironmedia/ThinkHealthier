...
<?php endif;?>
		...
		<table class="table table-striped" id="commentList">
			<thead>
				...
				<th class="wrap">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_REVIEWS_HEADING_COMMENT', 'rat.comment', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_YOORECIPE_HEADING_TITLE', 'r.title', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_REVIEWS_HEADING_NOTE', 'rat.note', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_REVIEWS_HEADING_AUTHOR', 'rat.author', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_REVIEWS_HEADING_EMAIL', 'rat.email', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_FIELD_IP_ADDRESS', 'rat.ip_address', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_YOORECIPE_HEADING_PUBLISHED', 'rat.published', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_YOORECIPE_REVIEWS_HEADING_OFFENSIVE', 'rat.abuse', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap hidden-phone">
			...
			<?php foreach($this->items as $i => $item): ?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap hidden-phone"><?php echo $item->note; ?></td>
					...
					<td class="nowrap hidden-phone"><?php echo $item->ip_address ?></td>
