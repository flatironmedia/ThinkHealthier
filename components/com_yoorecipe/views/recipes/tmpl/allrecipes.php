...
?>
<div class="pull-left">
	<h1><?php echo JText::_('COM_YOORECIPE_RECIPES_LIST'); ?></h1>
</div>

<?php if ($use_rss_feeds) { ?>
<div class="pull-right">
	<a href="<?php echo JRoute::_('index.php?option=com_yoorecipe&view=recipes&layout=allrecipes&format=feed&type=rss'); ?>">
