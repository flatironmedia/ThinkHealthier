...
?>
<div class="pull-left">
	<h1><?php echo JText::_('COM_YOORECIPE_RECIPES_MOST_RECENT_LIST'); ?></h1>
</div>

<?php if ($use_rss_feeds) { ?>
<div class="pull-right">
	<a href="<?php echo JRoute::_('index.php?option=com_yoorecipe&view=recipes&layout=mostrecents&format=feed&type=rss'); ?>">
...
if (count($this->items) == 0) {
	...
	$display_data['blog_show_creation_date'] 	= true;
