...
$recipe_author 	= new JUser($this->id);
$showAuthorName	= $yooRecipeparams->get('show_author_name', 'username');
$user_label 	= ($showAuthorName == 'username') ? $recipe_author->username : $recipe_author->name;

// Add styles and JS
$document->addStyleSheet('media/com_yoorecipe/styles/yoorecipe.css');
$document->addScript('media/com_yoorecipe/js/generic.js');
?>
<h1><?php echo JText::_('COM_YOORECIPE_RECIPES_OF_USER'); ?>&nbsp;<?php echo htmlspecialchars($user_label);?></h1>
...
if (count($this->items) == 0) {
	echo JText::_('COM_YOORECIPE_USER_HAS_NO_RECIPES_OF_THEIR_OWN');
}
else {
