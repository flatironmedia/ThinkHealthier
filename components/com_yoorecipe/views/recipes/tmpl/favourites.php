...
<div class="yoorecipe-top-favorites">
<?php
	$modules = JModuleHelper::getModules('yoorecipe-top-favorites');
	foreach($modules as $module) {
		echo JModuleHelper::renderModule($module);
	}
?>
</div>
<h1><?php echo JText::_('COM_YOORECIPE_RECIPES_FAVOURITES_RECIPES'); ?></h1>
