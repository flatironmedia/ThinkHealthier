...
$opened_by_default		= $params->get('opened_by_default', 0);
...
?>
	<div class="accordion" id="yr-accordion_<?php echo $module->id; ?>">
<?php
	...
	?>
		...
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#yr-accordion_<?php echo $module->id; ?>" href="#collapse<?php echo $module->id,'_',$i; ?>">
					<?php echo htmlspecialchars($item->title); ?>
				</a>
			</div>
			<div id="collapse<?php echo $module->id,'_',$i; ?>" class="accordion-body collapse <?php echo ($i == 0 && $opened_by_default) ? 'in' : ''; ?>">
			...
			if ($params->get('show_rating', 1)) {
				if ($item->note != null)  {
					...
					if ($params->get('rating_style', 'stars') == 'grade') {
						...
						echo '<div class="rating-stars-img-mod">';
						echo '</div>';
						echo '</div>';
						echo '</div>';
					}
