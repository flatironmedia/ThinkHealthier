...
// aceudovicic@ogosense.com: Overwrite category list with the category of the current article
//$params->set('jom_catid', array('0' => $_GET['catid']));
$params->set('jom_catid', array('0' => $app->input->get('catid')));
//echo('<pre>'.print_r($params->get('jom_catid'), true).'</pre>');
